...
const memories = [
  {
    ...
    gradientFrom: 'from-blossom/40',
    gradientTo: 'to-champagne/60',
    align: 'left' as const,
  },
  {
    ...
    gradientFrom: 'from-champagne/50',
    gradientTo: 'to-gold/30',
  ...
  },
  {
    ...
    gradientFrom: 'from-blush/30',
    gradientTo: 'to-blossom/50',
    align: 'left' as const,
  },
  {
    ...
    gradientFrom: 'from-parchment',
    gradientTo: 'to-champagne/70',
    align: 'right' as const,
  },
  {
    caption: "Two years. And I'd choose every single moment again.",
    subcaption: 'Happy anniversary, Adelin.',
    gradientFrom: 'from-blossom/60',
    gradientTo: 'to-blush/40',
    align: 'left' as const,
  },
]
